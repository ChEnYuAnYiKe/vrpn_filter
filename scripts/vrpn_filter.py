...
class VelocityBody:
    ...
    def __init__(self):
        ...
        input_lidar_height = rospy.get_param('~lidar_height_topic', '/lidar_position')
        rospy.loginfo("input lidar topic is %s", input_lidar_height)

        # rospy.Subscriber(input_vrpn_pose, PoseStamped, self.posCb)
        rospy.Subscriber(input_fused_pose, PoseStamped, self.fusedposCb)
        rospy.Subscriber(input_lidar_height, PoseStamped, self.lidarposCb)
